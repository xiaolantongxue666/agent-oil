...
const studentChildren: RouteRecordRaw[] = [
  ...
  { path: 'competition', name: 'competition-dashboard', component: () => import('@/views/CompetitionView.vue'), meta: { title: '比赛模式总览' } },
  ...
  { path: 'simulation/:code', name: 'simulation-workbench', component: () => import('@/views/student/SimulationWorkbenchView.vue'), meta: { roles: ['student'], title: '仿真实训台' } },
...
const teacherChildren: RouteRecordRaw[] = [
  ...
  { path: 'competition', name: 'teacher-competition', component: () => import('@/views/CompetitionView.vue'), meta: { title: '比赛模式总览' } },
  { path: 'professional-group', name: 'teacher-professional-group', component: () => import('@/views/teacher/ProfessionalGroupView.vue'), meta: { title: '专业群建设驾驶舱' } },
...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/admin', component: () => import('@/layouts/AdminLayout.vue'), redirect: '/admin/users', meta: { roles: ['admin'] }, children: [
    ...
    { path: 'competition', name: 'admin-competition', component: () => import('@/views/CompetitionView.vue'), meta: { title: '比赛模式总览' } },
